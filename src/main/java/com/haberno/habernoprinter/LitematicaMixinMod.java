...
public class LitematicaMixinMod implements ModInitializer {
    ...
    // Config settings
    public static final ConfigInteger BLOCKS_PER_TICK = new ConfigInteger("blocksPerTick", 2, 1, 50, "Printing interval. Lower values mean faster printing speed.\nIf the printer creates \"ghost blocks\" or blocks are facing the wrong way, raise this value.");
    public static final ConfigInteger PRINTING_INTERVAL = new ConfigInteger("printingInterval", 1, 1, 40, "Printing interval. Lower values mean faster printing speed.\nIf the printer creates \"ghost blocks\" or blocks are facing the wrong way, raise this value.");
